...
function init(config){    
    ...
    function CreateList() {        
        ...
        function editextensionconfig(e) {
            ...
            console.log(element.options.properties);
            
            // download(JSON.stringify(element.options.properties), 'change.txt', 'text/plain');
        ...
        function saveoptions() {
            ...
            download(JSON.stringify(Extensions[editoptionindex].options.properties), 'change.txt', 'text/plain');
